    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleGenerate} className="bg-[#111726] border border-[#1d273a] p-6 rounded-xl space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label className="text-xs text-gray-400 block mb-1">Target Scan</label>
            <select
          ...
          <div>
            <label className="text-xs text-gray-400 block mb-1">Custom Title (Optional)</label>
            <input
              type="text"
              value={reportTitle}
      ...
      <div className="bg-[#111726] border border-[#1d273a] rounded-xl overflow-hidden shadow-lg">
        <div className="p-4 border-b border-[#1d273a]">
                  ...
                  <tr key={r.id} className="hover:bg-[#151c2d] transition-colors">
                    ...
                    <td className="py-3 px-4 text-right">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1 px-3 py-1 bg-[#1a2333] hover:bg-[#232f44] border border-[#2b3952] rounded text-blue-400 hover:text-blue-300 font-medium"
                      >
